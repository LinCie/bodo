...
Welcome to the developer documentation for this Deno + Hono application using vertical slice architecture with clean architecture principles.
...
1. **New to the project?** Start with the [Developer Guide](./guides/developer-guide.md)
2. **Building a feature?** Follow the [Feature Development Checklist](./process/feature-development-checklist.md)
3. **Submitting changes?** Read the [Contribution Guide](./guides/contribution-guide.md)
4. **Reviewing code?** Use the [Code Review Checklist](./process/code-review-checklist.md)
